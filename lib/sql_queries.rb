...
"SELECT projects.title, SUM(pledges.amount) - projects.funding_goal as difference FROM projects INNER JOIN pledges on projects.id = pledges.project_id GROUP BY projects.id HAVING difference >= 0"
end
